    ...
    const appScreens = [
      {
        ...
        img: "https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?auto=format&fit=crop&q=80&w=300" 
      },
      {
        title: "Auditoria Fiscal",
        desc: "IA que analisa inconsistências em recibos e notas fiscais de serviços.",
        img: "https://images.unsplash.com/photo-1554224155-1696413575b9?auto=format&fit=crop&q=80&w=300" 
      },
      {
        title: "Documentação",
        desc: "Organização por pastas inteligentes para facilitar a declaração anual.",
        img: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&q=80&w=300"
      },
      {
        title: "Lançamento Rápido",
        desc: "Registro de rendas e despesas dedutíveis em poucos segundos.",
        img: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=300"
      }
    ];

    return (
      <div className="bg-white min-h-screen animate-fadeIn">
        {/* Hero Meu IR - Compactado para evitar anúncios */}
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.6fr] gap-8 items-center">
              <div className="text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    ...
                    className="bg-blue-700 text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-blue-800 transition shadow-lg active:scale-95 group text-xs uppercase tracking-widest"
                  >
              ...
              <div className="relative flex justify-center lg:justify-end">
                ...
                <img 
                  src="https://images.unsplash.com/photo-1454165833767-027ffea9e78b?auto=format&fit=crop&q=80&w=500" 
                  alt="Interface Meu IR" 
                  className="relative z-10 rounded-[2rem] shadow-xl border-2 border-white max-w-full h-auto lg:max-h-[260px] object-cover transform lg:-rotate-1"
                />
              </div>
            </div>
          </div>
        ...
        {/* Galeria de Interface do App - Imagens Menores */}
                ...
                <div key={idx} className="min-w-[180px] md:min-w-[220px] snap-center flex flex-col items-center text-center">
                  <div className="bg-white rounded-[1.5rem] p-1 shadow-lg border border-gray-100 mb-4 transform hover:-translate-y-1 transition-transform duration-500">
                    <img 
                      src={screen.img} 
                      alt={screen.title} 
                      className="rounded-[1.2rem] w-full aspect-[3/4] object-cover"
                    />
                  </div>
                  <h4 className="font-black text-gray-900 text-[10px] mb-1 uppercase tracking-tighter">{screen.title}</h4>
                  <p className="text-gray-400 text-[9px] leading-tight max-w-[160px] font-medium uppercase tracking-tighter">{screen.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 text-center bg-gray-50 border-t border-gray-100">
           ...
           <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-blue-700 text-white px-8 py-3.5 rounded-xl font-bold text-xs uppercase tracking-widest shadow-xl hover:bg-blue-800 transition transform active:scale-95 flex items-center gap-3 mx-auto w-max"
           >
  ...
  const precoCertoScreens = [
    {
      ...
      img: "https://images.unsplash.com/photo-1556742049-13da73667422?auto=format&fit=crop&q=80&w=300"
    },
    {
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=300"
    }
  ];

  return (
    <div className="bg-white min-h-screen animate-fadeIn">
      {/* Hero Preço Certo - Design Ajustado para Telas com Anúncios */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.6fr] gap-8 items-center">
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              <img 
                src="https://images.unsplash.com/photo-1556742044-3c52d6e88c62?auto=format&fit=crop&q=80&w=500" 
                alt="App Interface" 
                className="relative z-10 rounded-[2rem] shadow-xl border-2 border-white max-w-full h-auto lg:max-h-[260px] object-cover transform lg:rotate-1"
              />
            </div>
      ...
      {/* Tour pela Interface - Preço Certo (Imagens Reduzidas) */}
      ...
      {/* O que o app faz por você - Detalhado Conforme Solicitação */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 bg-white rounded-[2rem] border border-gray-100 group hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-6 text-blue-600 text-lg group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 bg-white rounded-[2rem] border border-gray-100 group hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center mb-6 text-green-600 text-lg group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 bg-white rounded-[2rem] border border-gray-100 group hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mb-6 text-purple-600 text-lg group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 bg-white rounded-[2rem] border border-gray-100 group hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center mb-6 text-amber-600 text-lg group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 bg-white rounded-[2rem] border border-gray-100 group hover:shadow-xl transition-all duration-500">
              <div className="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center mb-6 text-indigo-600 text-lg group-hover:scale-110 transition-transform">
                <i className="fas fa-history"></i>
              </div>
              <h3 className="text-base font-black mb-3">Gestão de Lucro</h3>
              <p className="text-gray-500 text-xs leading-relaxed">Mostra quanto você vai ganhar em cada produto (venda por unidade ou caixa) e mantém um histórico de todas as suas compras.</p>
            </div>
      ...
      <section className="py-20 text-center bg-gray-900 text-white rounded-[3rem] mx-4 mb-16 shadow-2xl relative overflow-hidden">
         ...
         <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-blue-600 text-white px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest shadow-2xl hover:bg-blue-500 transition active:scale-95 flex items-center gap-3 mx-auto w-max relative z-10"
         >
